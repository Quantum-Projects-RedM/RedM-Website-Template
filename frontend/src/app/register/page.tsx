        ...
        <div className="max-w-md mx-auto">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Username Field */}
              <div>
                <label htmlFor="username" className="block text-white font-bold mb-2" style={{fontFamily: 'Cinzel, serif'}}>
                  USERNAME
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-white font-bold mb-2" style={{fontFamily: 'Cinzel, serif'}}>
                  CONFIRM PASSWORD
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
